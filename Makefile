...
# Generated by qmake (2.01a) (Qt 4.5.1) on: Mon Dec 7 15:03:40 2009
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/faculdade1.0.0/ && $(COPY_FILE) --parents mainwindow.h aluno.hpp professor.hpp pessoa.hpp curso.h disciplina.h turma.h aluno.h pessoa.h .tmp/faculdade1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp curso.cpp disciplina.cpp turma.cpp aluno.cpp pessoa.cpp .tmp/faculdade1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/faculdade1.0.0/ && (cd `dirname .tmp/faculdade1.0.0` && $(TAR) faculdade1.0.0.tar faculdade1.0.0 && $(COMPRESS) faculdade1.0.0.tar) && $(MOVE) `dirname .tmp/faculdade1.0.0`/faculdade1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/faculdade1.0.0
