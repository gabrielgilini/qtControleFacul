...
# Generated by qmake (2.01a) (Qt 4.5.1) on: Tue Dec 1 17:52:16 2009
# Project:  faculdade.pro
# Template: app
# Command: /usr/bin/qmake -unix -o Makefile faculdade.pro
#############################################################################
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		curso.cpp \
		disciplina.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		curso.o \
		disciplina.o \
...
Makefile: faculdade.pro  /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/common/g++.conf \
	...
	$(QMAKE) -unix -o Makefile faculdade.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/faculdade1.0.0/ && $(COPY_FILE) --parents mainwindow.h disciplina.hpp aluno.hpp turma.hpp professor.hpp pessoa.hpp curso.h disciplina.h .tmp/faculdade1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp curso.cpp disciplina.cpp .tmp/faculdade1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/faculdade1.0.0/ && (cd `dirname .tmp/faculdade1.0.0` && $(TAR) faculdade1.0.0.tar faculdade1.0.0 && $(COMPRESS) faculdade1.0.0.tar) && $(MOVE) `dirname .tmp/faculdade1.0.0`/faculdade1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/faculdade1.0.0
